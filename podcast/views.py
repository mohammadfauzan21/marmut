...
def podcast_view(request):
    ...
    try:
        with connection.cursor() as cursor:
            ...
            kelola_podcasts = [(id_konten, judul_podcast, jumlah_episode, format_durasi(total_durasi)) for id_konten, judul_podcast, jumlah_episode, total_durasi in kelola_podcasts]
